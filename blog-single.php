            ...
            <form action="blog-single.php" method="post" enctype="multipart/form-data" style="border: 1px solid gray"> 
              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <input type="text" class="form-control" placeholder="Enter your First Name" name="first_name" id="">
                  ...
                  <input type="text" class="form-control" placeholder="Enter your Last Name" name="last_name" id="">
                  ...
                  <input type="date" class="form-control" placeholder="Enter Date of Birth" name="dob" id="">
