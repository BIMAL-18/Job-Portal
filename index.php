			              			...
			              			<div class="col-md">
			              				<div class="form-group">
				              				<div class="form-field">
								                ...
								                <input type="text" class="form-control" name="key" id="key" placeholder="eg. Garphic. Web Developer">
								              </div>
							              </div>
			              			</div>
			              			<div class="col-md">
...
$sql = mysqli_query($conn, "
    SELECT DISTINCT all_jobs.*, company.company, company.des 
    FROM all_jobs 
...
if(isset($_POST['search'])){
    ...
    if(!empty($keyword) && !empty($category)){
        $condition = "WHERE all_jobs.job_title LIKE '%$keyword%' AND all_jobs.category = '$category'";
    }
    elseif(!empty($keyword)){
        $condition = "WHERE all_jobs.job_title LIKE '%$keyword%'";
    }
    elseif(!empty($category)){
        $condition = "WHERE all_jobs.category = '$category'";
    }
